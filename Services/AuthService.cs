...
(@FirstName, @LastName, @Email, @PasswordHash, @Address, @City, @BloodType, @Gender, @BirthDate, @Phone, @FamilyDoctorId, NOW(), 1);";
        ...
        public void UpdatePatientProfileAfterRegistration(string email, string phone, string address, string city, string bloodType, string gender, DateTime birthDate)
        {
            string query = @"
UPDATE Patients
SET Phone = @Phone,
