...
(
    ...
    NOW()
        ...
        private List<AdminDoctorCard> GetDoctors(MySqlConnection connection)
        {
            ...
            using (MySqlCommand command = new MySqlCommand(@"
SELECT DoctorId, FirstName, LastName, Email, Gender, BirthDate, Specialization, CreatedAt, IsActive
FROM Doctors
...
INSERT INTO Doctors
(FirstName, LastName, Email, PasswordHash, Gender, BirthDate, Specialization, CreatedAt, IsActive, Avatar)
VALUES
