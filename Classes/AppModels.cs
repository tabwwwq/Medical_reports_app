...
namespace MedicalReportsApp.Classes
{
    ...
    public class DoctorChatContactCard
    {
        public int DoctorId { get; set; }
        public string FullName { get; set; }
        public string Specialization { get; set; }
        ...
        public string LastVisitText
        {
            get { return LastVisitDate == null ? "Family doctor" : "Last visit: " + LastVisitDate.Value.ToString("yyyy-MM-dd"); }
        }

        public string AccessText
        {
            get { return IsFamilyDoctor ? "Family doctor" : LastVisitText; }
        }
    }
