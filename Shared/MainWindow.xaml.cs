...
namespace MedicalReportsApp
{
    public partial class MainWindow : Window
    {
        ...
        {
            InitializeComponent();
            txtSubtitle.Text = "Register patient account with email verification";
        }
        ...
        private void btnSendCode_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                authService.StartRegistration(email, password, "Patient");
        ...
        private void btnResend_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                authService.StartRegistration(savedEmail, savedPassword, "Patient");
