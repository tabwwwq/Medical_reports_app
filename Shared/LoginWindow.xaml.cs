...
namespace MedicalReportsApp
{
    public partial class LoginWindow : Window
    {
        ...
        private void btnPatientTab_Click(object sender, RoutedEventArgs e)
        {
            ...
            btnAdminTab.Style = (Style)FindResource("TabInactiveStyle");
            ClearError();
        }
        ...
        private void btnAdminTab_Click(object sender, RoutedEventArgs e)
        {
            selectedRole = "Admin";
            btnAdminTab.Style = (Style)FindResource("TabActiveStyle");
            btnPatientTab.Style = (Style)FindResource("TabInactiveStyle");
            btnDoctorTab.Style = (Style)FindResource("TabInactiveStyle");
            ClearError();
        }
        ...
        private void btnSignIn_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                if (!ok)
                {
                    string blockedMessage = authService.GetBlockedAccountMessage(email, selectedRole);
                ...
                if (authService.IsTwoFactorRequired(email, selectedRole))
                {
                    TwoFactorLoginWindow twoFactorWindow = new TwoFactorLoginWindow(email);
                    twoFactorWindow.Owner = this;
                    bool? twoFactorResult = twoFactorWindow.ShowDialog();
                ...
                {
                    PatientDashboardWindow dashboardWindow = new PatientDashboardWindow(email);
                ...
                {
                    DoctorDashboardWindow doctorDashboardWindow = new DoctorDashboardWindow(email);
                    doctorDashboardWindow.Show();
                    Close();
                    return;
                }

                AdminDashboardWindow adminDashboardWindow = new AdminDashboardWindow(email);
