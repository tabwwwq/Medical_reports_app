    ...
    public class ChatWindow : Window
    {
        ...
        private void LoadChat()
        {
            try
            {
                ...
                if (!allowed)
                {
                    MessageBox.Show("Chat is available with your family doctor or with a doctor who added visit information for you.", "Messages", MessageBoxButton.OK, MessageBoxImage.Information);
                    Close();
                    return;
                }
