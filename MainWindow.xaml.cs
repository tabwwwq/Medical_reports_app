    ...
    public partial class MainWindow : Window
    {
        ...
        private void UpdateRoleUi()
        {
            if (selectedRole == "Doctor")
            {
                ...
                txtSubtitle.Text = "Register doctor account with email verification";
            }
            else
            {
                btnPatientTab.Style = (Style)FindResource("TabActiveStyle");
                btnDoctorTab.Style = (Style)FindResource("TabInactiveStyle");
                txtSubtitle.Text = "Register with email verification";
            }
        }
        ...
        private void btnSendCode_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                authService.StartRegistration(email, password, selectedRole);
        ...
        private void btnVerify_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                string createdRole = authService.VerifyCodeAndCreateAccount(savedEmail, code);

                if (string.IsNullOrWhiteSpace(createdRole))
                {
                ...
                {
                    DoctorCompleteProfileWindow doctorWindow = new DoctorCompleteProfileWindow(savedEmail);
                    doctorWindow.Show();
                    Close();
                    return;
                }

                CompleteProfileWindow patientWindow = new CompleteProfileWindow(savedEmail);
                patientWindow.Show();
                Close();
            }
            catch (Exception ex)
        ...
        private void btnResend_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                authService.StartRegistration(savedEmail, savedPassword, selectedRole);
        ...
        private void FreezeRegisterFields(bool freeze)
        {
            ...
            btnPatientTab.IsEnabled = !freeze;
            btnDoctorTab.IsEnabled = !freeze;
        }
