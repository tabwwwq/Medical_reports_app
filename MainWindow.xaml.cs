...
namespace MedicalReportsApp
{
    public partial class MainWindow : Window
    {
        ...
        private void FreezeRegisterFields(bool freeze)
        {
            ...
            if (freeze)
            {
                txtEmail.Background = new SolidColorBrush((Color)ColorConverter.ConvertFromString("#FFF1F5F9"));
            }
            else
            {
                txtEmail.Background = new SolidColorBrush((Color)ColorConverter.ConvertFromString("#FFF8FAFC"));
            }
        }
