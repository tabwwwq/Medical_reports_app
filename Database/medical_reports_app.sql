...
--
-- Хост: 127.0.0.1
-- Время создания: Май 04 2026 г., 00:06
...
--
-- Структура таблицы `doctorpatientmessages`
--
...
--
-- Индексы таблицы `doctorpatientmessages`
--
ALTER TABLE `doctorpatientmessages`
  ADD PRIMARY KEY (`MessageId`),
  ADD KEY `IX_DoctorPatientMessages_PatientDoctor` (`PatientId`,`DoctorId`),
  ADD KEY `IX_DoctorPatientMessages_CreatedAt` (`CreatedAt`),
  ADD KEY `FK_DoctorPatientMessages_Doctor` (`DoctorId`);
...
--
-- AUTO_INCREMENT для таблицы `doctorpatientmessages`
--
ALTER TABLE `doctorpatientmessages`
...
--
-- Ограничения внешнего ключа таблицы `doctorpatientmessages`
--
ALTER TABLE `doctorpatientmessages`
  ADD CONSTRAINT `FK_DoctorPatientMessages_Doctor` FOREIGN KEY (`DoctorId`) REFERENCES `doctors` (`DoctorId`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_DoctorPatientMessages_Patient` FOREIGN KEY (`PatientId`) REFERENCES `patients` (`PatientId`) ON DELETE CASCADE;
